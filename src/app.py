...
iexec_task_id = getenv('IEXEC_TASK_ID')

iexec_in = getenv('IEXEC_IN')
iexec_out = getenv('IEXEC_OUT')

dataset = getenv('IEXEC_DATASET_FILENAME')
dataset_address = getenv('IEXEC_DATASET_ADDRESS')
dataset_checksum = getenv('IEXEC_DATASET_CHECKSUM')
dataset_url = getenv('IEXEC_DATASET_URL')
...
if __name__ == '__main__':
    ...
    stdout(f'Task ID: {iexec_task_id}')
    ...
    try:
        ...
        stdout(f'Dataset Name: {dataset}')
        stdout(f'Dataset Address: {dataset_address}')
        stdout(f'Dataset URL: {dataset_url}')
        stdout(f'Dataset Checksum: {dataset_checksum}')
